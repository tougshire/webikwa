...
class DocumentBlock(StructBlock):
    ...
    class Meta:
        icon = "doc-full"
        template = "webikwa/blocks/document_block.html"
...
class ImageBlock(StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "webikwa/blocks/image_block.html"
...
class ExternalImageBlock(StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "webikwa/blocks/external_image_block.html"
...
class HeadingBlock(StructBlock):
    ...
    class Meta:
        icon = "title"
        template = "webikwa/blocks/heading_block.html"
